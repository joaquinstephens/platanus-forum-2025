...
const Index = () => {
  ...
  return (
    <main className="relative text-center min-h-screen">
      ...
      <div className="w-full flex flex-col items-center gap-6 justify-center pb-12 pt-48 mx-auto">
      ...
      <div className="relative -mt-[576px]">
        ...
        <div className="md:max-w-sm text-muted-foreground absolute px-4 bottom-12 left-1/2 -translate-x-1/2 z-20 flex justify-between w-full font-mono uppercase [&_a]:underline [&_a]:decoration-muted-foreground/15 [&_a]:px-1.5 [&_a]:py-1 [&_a]:bg-black">
          ...
          <Link to="https://www.instagram.com/platanusventureshttps://arc.net/l/quote/rszitxjk" target="_blank">
            Instagram
          </Link>
        </div>
