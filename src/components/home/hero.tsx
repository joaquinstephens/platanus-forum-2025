...
//   {
//     src: "/lovable-uploads/25090221-6a61-4858-8aab-b1922cde6c82.webp",
//     alt: "Platanus Forum presentation with mining displays",
//   },
//   {
//     src: "/lovable-uploads/8e7b4326-eeeb-40eb-abbe-524536502eb5.webp",
//     alt: "Earth AI presentation at forum",
//   },
//   {
//     src: "/lovable-uploads/f9903767-5b74-4659-81a8-bae8ce2b2692.webp",
//     alt: "Gizmodo asteroid mining presentation",
//   },
//   {
//     src: "/lovable-uploads/ed64df99-87c0-4897-a3dc-1672f0425525.webp",
//     alt: "AstroForge speaker presenting",
//   },
//   {
//     src: "/lovable-uploads/13884d98-0fcf-4d2f-babd-806f510eabcb.webp",
//     alt: "Platanus Forum presentation",
//   },
//   {
//     src: "/lovable-uploads/c7879c52-30b8-40cc-b12b-81ca3e49614d.webp",
//     alt: "Forum attendees listening",
//   },
//   {
//     src: "/lovable-uploads/51c77275-536b-4367-9b70-da20cf4ca6b2.webp",
//     alt: "Speaker at Platanus Forum",
//   },
//   {
//     src: "/lovable-uploads/8b0c9c08-0dee-4aa0-89cd-69a8a2cc3391.webp",
//     alt: "Audience at the forum",
//   },
//   {
//     src: "/lovable-uploads/0dc03ae6-91df-43aa-9680-7fae4f2d10c7.webp",
//     alt: "Person working during event",
//   },
//   {
//     src: "/lovable-uploads/8973a3c2-a53b-4386-b08b-fe8f28bf29b3.webp",
//     alt: "Networking on terrace",
//   },
//   {
//     src: "/lovable-uploads/0665bd3c-4fef-47e2-b820-d87a15654350.webp",
//     alt: "Outdoor networking event",
//   },
//   {
//     src: "/lovable-uploads/791c36a4-7ab7-4ee1-a683-42d987a72efd.webp",
      ...
      <div className="hidden absolute inset-0 w-full h-full min-h-svh justify-center items-center overflow-hidden">
        <Floating sensitivity={1} easingFactor={0.08}>
          ...
          <FloatingElement depth={2} className="top-[19%] left-[56%] md:top-[10%] md:left-[32%]">
            <img src="/lovable-uploads/8e7b4326-eeeb-40eb-abbe-524536502eb5.webp" alt="Earth AI presentation at forum"             className="w-20 h-20 md:w-28 md:h-28 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform" />
          </FloatingElement>
          <FloatingElement depth={3} className="top-[2%] left-[85%] md:top-[2%] md:left-[53%]">
            <img src="/lovable-uploads/f9903767-5b74-4659-81a8-bae8ce2b2692.webp" alt="Gizmodo asteroid mining presentation"             className="w-28 h-40 md:w-40 md:h-52 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform"
 />
          </FloatingElement>
          <FloatingElement depth={1} className="top-[83%] left-[10%] md:top-[0%] md:left-[83%]">
            <img src="/lovable-uploads/ed64df99-87c0-4897-a3dc-1672f0425525.webp" alt="AstroForge speaker presenting"             className="w-24 h-24 md:w-32 md:h-32 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform"
 />
          </FloatingElement>
          <FloatingElement depth={2} className="top-[73%] left-[65%] md:top-[40%] md:left-[2%]">
            <img src="/lovable-uploads/13884d98-0fcf-4d2f-babd-806f510eabcb.webp" alt="Platanus Forum presentation"             className="w-28 h-28 md:w-36 md:h-36 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform"
 />
          </FloatingElement>
          <FloatingElement depth={3} className="top-[95%] left-[55%] md:top-[60%] md:left-[77%]">
            <img src="/lovable-uploads/c7879c52-30b8-40cc-b12b-81ca3e49614d.webp" alt="Forum attendees listening" className="w-[60px] h-[60px] object-cover rounded-sm grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer hover:scale-105" />
          </FloatingElement>
          ...
          <FloatingElement depth={3} className="top-[50%] left-[40%]">
            <img src="/lovable-uploads/0dc03ae6-91df-43aa-9680-7fae4f2d10c7.webp" alt="Person working during event" className="w-[60px] h-[60px] object-cover rounded-sm grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer hover:scale-105" />
          </FloatingElement>
          <FloatingElement depth={1} className="top-[50%] left-[55%]">
            <img src="/lovable-uploads/8973a3c2-a53b-4386-b08b-fe8f28bf29b3.webp" alt="Networking on terrace" className="w-[60px] h-[60px] object-cover rounded-sm grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer hover:scale-105" />
          </FloatingElement>
          <FloatingElement depth={2} className="top-[50%] left-[70%]">
            <img src="/lovable-uploads/0665bd3c-4fef-47e2-b820-d87a15654350.webp" alt="Outdoor networking event" className="w-[60px] h-[60px] object-cover rounded-sm grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer hover:scale-105" />
          </FloatingElement>
