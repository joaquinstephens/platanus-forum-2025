...
export default function Sponsors() {
  ...
  return (
    <section className="max-w-screen-lg w-full px-8 my-8 mx-auto flex flex-col justify-start items-start gap-8">
      ...
      <Link
        to="https://www.buk.cl/"
        style={shimmerStyle}
        className="bg-foreground/[3%] group ease-out transition-transform w-full p-8 flex items-center justify-center border-2 border-border font-mono uppercase h-auto text-left *:px-4 *:py-4 animate-shiny-text bg-no-repeat [background-size:var(--shiny-width)_100%] bg-gradient-to-r from-transparent via-foreground/[2%] via-50% to-transparent"
      >
      ...
      <div className="w-full flex gap-8">
        <Link
          to="https://www.buk.cl/"
          style={shimmerStyle}
          className="bg-foreground/[3%] group ease-out transition-transform w-full p-8 flex items-center justify-center border-2 border-neutral-800 font-mono uppercase h-auto text-left *:px-4 *:py-4 animate-shiny-text bg-no-repeat [background-size:var(--shiny-width)_100%] bg-gradient-to-r from-transparent via-foreground/[2%] via-50% to-transparent"
        >
          <div className="sr-only">Buk</div>
          <img src="/logos/logo-buk.svg" className="scale-100 group-hover:scale-105 ease-out" />
        </Link>
