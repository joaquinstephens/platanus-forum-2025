...
export function MatrixRipple({
  ...
  return (
    <div
      className="absolute translate-y-1/2 w-screen bottom inset-x-0 flex items-center justify-center bg-background font-mono text-xs"
    ...
    >
      ...
      <div className="pond-container w-screen">
